...
public class StateMachineTest {
	...
	public void setUp() {
		...
		stateMachineDefinition.in(States.A)
				.executeOnEntry(new RecordEntryAction(States.A))
				.executeOnExit(new RecordExitAction(States.A)).on(Events.B)
				.goTo(States.B).on(Events.C).goTo(States.C).on(Events.D)
				.goTo(States.D).on(Events.A);

		stateMachineDefinition.in(States.B)
				.executeOnEntry(new RecordEntryAction(States.B))
				.executeOnExit(new RecordExitAction(States.B));

		stateMachineDefinition.in(States.B1)
				.executeOnEntry(new RecordEntryAction(States.B1))
				.executeOnExit(new RecordExitAction(States.B1)).on(Events.B2)
				.goTo(States.B2);

		stateMachineDefinition.in(States.B2)
				.executeOnEntry(new RecordEntryAction(States.B2))
				.executeOnExit(new RecordExitAction(States.B2)).on(Events.A)
				.goTo(States.A).on(Events.C1b).goTo(States.C1b);

		stateMachineDefinition.in(States.C)
				.executeOnEntry(new RecordEntryAction(States.C))
				.executeOnExit(new RecordExitAction(States.C)).on(Events.A)
				.goTo(States.A);

		stateMachineDefinition.in(States.C1)
				.executeOnEntry(new RecordEntryAction(States.C1))
				.executeOnExit(new RecordExitAction(States.C1));

		stateMachineDefinition.in(States.C2)
				.executeOnEntry(new RecordEntryAction(States.C2))
				.executeOnExit(new RecordExitAction(States.C2));

		stateMachineDefinition.in(States.C1a)
				.executeOnEntry(new RecordEntryAction(States.C1a))
				.executeOnExit(new RecordExitAction(States.C1a));

		stateMachineDefinition.in(States.C1b)
				.executeOnEntry(new RecordEntryAction(States.C1b))
				.executeOnExit(new RecordExitAction(States.C1b)).on(Events.A)
				.goTo(States.A);

		stateMachineDefinition.in(States.D)
				.executeOnEntry(new RecordEntryAction(States.D))
				.executeOnExit(new RecordExitAction(States.D));

		stateMachineDefinition.in(States.D1)
				.executeOnEntry(new RecordEntryAction(States.D1))
				.executeOnExit(new RecordExitAction(States.D1));

		stateMachineDefinition.in(States.D1a)
				.executeOnEntry(new RecordEntryAction(States.D1a))
				.executeOnExit(new RecordExitAction(States.D1a));

		stateMachineDefinition.in(States.D1b)
				.executeOnEntry(new RecordEntryAction(States.D1b))
				.executeOnExit(new RecordExitAction(States.D1b)).on(Events.A)
				.goTo(States.A).on(Events.B1).goTo(States.B1);

		stateMachineDefinition.in(States.E)
				.executeOnEntry(new RecordEntryAction(States.E))
				.executeOnExit(new RecordExitAction(States.E)).on(Events.A)
				.goTo(States.A);
